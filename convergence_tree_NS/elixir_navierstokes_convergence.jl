...
equations = TrixiLW.CompressibleEulerEquations2D(1.4)
...
boundary_condition_top_bottom = TrixiLW.BoundaryConditionNavierStokesWall(velocity_bc_top_bottom, heat_bc_top_bottom)
